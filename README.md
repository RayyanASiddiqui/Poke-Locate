...
In future updates, I have a number of goals:
- Add in support for Generation 9 games.
- Compile this into a proper package that can be installed and used more conveniently.
- Add in extra features / information as per needed / requested.

I am open to feedback and suggestions on this if anyone is interested in this.
